...
<title> Share History | GoFounders</title>
         ...
         <div class="card shadow">
            <div class="container mt-3">
               ...
               <div class="tab-content border mb-3">
                  <button data-toggle="modal" data-target="#myModal00" class="btn fbtn btn-primary" style=" float: right; margin-bottom: 1rem; margin-top:0.5rem;">
                     Export CSV File 
                     <svg aria-hidden="true" data-prefix="far" data-icon="file-excel" 
                        class="svg-inline--fa fa-file-excel fa-w-12" role="img" xmlns="http://www.w3.org/20/svg" 
                        viewBox="0 0 384 512" width="16px" height="16px">
                     ...
                     <!--<i class="fas fa-file-excel"></i>--><!--<i class="fa fa-file-excel"></i>--><!--<i class="fas fa-file-export"></i>--><!-- <img src="https://img.icons8.com/material/18/ffffff/export.png">-->
                  </button>
                  <a href="user_link"><button  class="btn fbtn btn-primary" style=" float: right;margin-right: 12px; margin-bottom: 1rem; margin-top: 0.5rem;"> Back To My Links <i class="fas fa-arrow-circle-left"></i>
                  </button></a>
                  <p><br></p>
    ...
    <div class="modal-dialog modal-sm modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title">Export My Links to CSV?</h2>
        </div>
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                  ...
                  <div id="home" class="container tab-pane active table-responsive">
                    ...
                    <table class="table align-items-center table-flush" id="table1">
                        ...
                        <thead class="thead-dark">
                          ...
                          <c:forEach var="ulink" items="${user_link}" varStatus="counter">   
                                  ...
                                  <td>
                                   ...
                                   <td>
                                       <span>${ulink.email}</span>
                                  </td>
                                   <td>                                                            
                                       <a>${ulink.link}</a>
                                  </td>
                                  <td>                              
                                       <span>${ulink.date}</span>
                                  </td>
                                  </tr>
                  ...
                  <div id="menu1" class="container tab-pane fade d-none">                   
                     <form method="post" action="" enctype="multipart/form-data">
                        <div class="pl-lg-4">
                           <div class="row">
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    <label class="form-control-label" for="input-first-name">Marketing Name</label>
                                    <input type="text" id="input-first-name" class="form-control form-control-alternative" name="webinar_name" required=""  value="">
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    <label class="form-control-label" for="input-last-name">Marketing Type</label>
                                    <input type="text" id="input-last-name" name="webinar_type" class="form-control form-control-alternative"  value="">
                                 </div>
                              </div>
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    <label class="form-control-label" for="input-last-name">Video File</label>
                                    <input type="file" id="input-last-name" name="file" class="form-control form-control-alternative" >
                                 </div>
                              </div>
                              <input type="submit" class="btn btn-primary" name="sbmt" value="Add">
                           </div>
                        </div>
                     </form>
                  </div>
         ...
         <div class="modal-body">
            <div class="card-body p-3">
               <form method="post" action="">
                  ...
                  <input type="hidden" class="form-control" id="email1" name="email1" value="" required=""  >
                  <div class="form-group">                                   
                     <label for="email">Subject</label>
                     <input type="text" class="form-control" id="sub" name="sub" value="" required=""  >
                  </div>
                  <div class="form-group">                                   
                  ...
                  <div class="form-group">                                  
                     ...
                     <textarea  name="msg" class="form-control" id="editor2" placeholder="Enter your message" required=""></textarea>                                   
                  </div>
                  <div class="text-center">
                     <input type="submit" value="Submit" id="sbmitall"  name="sbmitall" class="btn btn-info btn-block rounded-0 py-2">
                  </div>
            </div>
            </form>
         </div>
...
<script>
   function Export()
   {
           ...
           window.open("downloadCSV", '_blank');
