...
<head>
    ...
    <title> Library | GoFounders</title>

    <link href="https://www.gofounders.net/assests/css/gallery/lightgallery.css" rel="stylesheet">
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,700,800,900|Oswald:400,500,600,700&display=swap"
        rel="stylesheet">
    ...
    <script  src="https://www.gofounders.net/assests/js/argon.js?v=1.0.0"></script>

    <script src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/ckeditor.js"></script>

    <script  src="https://www.gofounders.net/assests/js/video.min.js"></script>
...
<body class="user_profile user_body">
        ...
        <div class="sidebar-inner">
            ...
            <div class="collapse navbar-collapse" id="g-toogler">
                <ul class="sidebar-menu mb-0" style="">
                    ...
                    <li class="nav-item">
                        <a class="sidebar-link activenow" href="https://www.gofounders.net/user_profile">
                            <span class="icon-holder">
        ...
        <div class="main-content">
            ...
            <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                <div class="container-fluid">
                    ...
                    <!-- Brand -->
                    <a class="h4 mb-0 text-white text-uppercase main-title  d-flex">Library</a>
    ...
    <ul class="navbar-nav align-items-center ml-md-auto" id="ul_community_head_id">
                        ...
                        <a class="nav-link position-relative notification-icon community-notifiocation" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="notification-row " id="notify_com_popup_bx">
                                ...
                                <div class="px-3 py-3" id="com_noti_headlines">
                                                                                                    <h6 class="text-sm text-muted m-0">New <strong class="text-primary" id="count_community">24</strong> communities posted by <span>Administrator</span></h6>
                        ...
                        <div class="list-group list-group-flush">
                                <ul id="all_ul"> 
                                            ...
                                            <a href="javascript:void(0);" class="poscom_1475531 community-new-popup" id="1475531">
                                            Adminstrator posted community <span><p><span style="color:#0000CD;"><strong><span style="font-size:28px;">The Movement Has Begun</span></strong></span></p>
    ...
    <div class="notification-row">
                            ...
                            <div class="px-3 py-3">
                            <h6 class="text-sm text-muted m-0">You have <strong class="text-primary">120</strong> notifications from <span>Download</span></h6>
                            </div>
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div class="media align-items-center">
                                    ...
                                    <span class="avatar avatar-sm rounded-circle avatar-bg" style="background-image:url('https://d1iy5wifs53qnq.cloudfront.net/8561705301118697793saikat.jpg')">
    ...
    .library-thumb {
    margin: 15px 0;
    box-shadow: 0px 0px 9px #9e9e9e;
    border: 1px solid #ccc;
    }


    .media-lavel span.upload {
    position: relative;
    top: 38px;
    margin-right: 0px;
    left: 7px;
    ...
    .media-lavel span.upload input {font-size: 60px;}

    .media-lavel span.upload input#file-upload-file {
    padding-left: 50px;
    }


    .media-lavel input#file-upload-file {
    padding-top: 13px;
    padding-left: 77px;
    padding-bottom: 13px;
    height: 51px;
    ...
    <!-- Page content -->
        ...
        <div class="card bg-secondary shadow" style="margin-top: 6%;">

        

            <div class="card-body" style="background: #043b82 url(https://www.gofounders.net/assests/img/pattern2.png);     padding: 20px 30px 40px!important;">
                

            <form method="post" action="uploadFileLibray" enctype="multipart/form-data">
                            <div class="">
                                <div class="row">
                                ...
                                <label class="form-control-label" for="input-last-name">Upload Media file</label>
                                
                                
                                <div class="box-input">
                                    <input type="file" name="file" id="file-7" class="inputfile inputfile-6" data-multiple-caption="{count} files selected" required="">
                                    <label for="file-7"><span>No file choosen</span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17"><path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"></path></svg> Upload a file…</strong></label>
                                </div>




                                <label class="upload-label  media-lavel" for="file-upload-file">
                                    
                                <!--<span class="upload">

                                    Upload a file <img src="https://www.gofounders.net/assests/emoji/img/upload.png"> 
                                    
                                    </span>
                                
                                    <input type="file" class="form-control"  name="image" id="file-upload-file"  required/> -->

                                    <p class="mb-0 mt-0" style="font-size:18px;color: #fffcfc;font-weight: 350;"><b>*(Use .jpg, .png or .gif format Picture.)</b></p>
                                
                                    <input type="hidden" class="form-control" name="user_id" value="29980" id="file-upload-file">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="submit" class="btn btn-primary" name="sbmt" value="Upload">
            ...
            <div class="tab-content mb-3">
                        <div id="home" class="tab-pane active"><br>
                                        ...
                                        <div class=" post-boxes">
                                                ...
                                                <div class="row align-items-center lightgallery">
...
<c:forEach var="listValue" items="${lists}">
                                                ...
                                                <div class="col-lg-3 col-md-4 col-6 lightgallery">
                                                        ...
                                                        <div class="library-thumb" data-src="https://d1iy5wifs53qnq.cloudfront.net/${listValue}" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/${listValue})">
                                                            
                                                        <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/${listValue}" alt="">
                                                                    
                                                                    <div class="demo-gallery-poster">
                                                                        <img src="https://www.gofounders.net/assests/css/img/zoom.png">
                                                                    </div>
                                                                    

                                                                    <a href="" class="delete-i" data-toggle="modal" data-target="#myModal0011" title="Delete" data-placement="top"><i class="fa fa-times" style="font-size:20px"></i></a>
                                                            </div>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <h2 class="modal-title">Are you sure want to delete this?</h2>
                                                                </div>
                                                            
                                                                <div class="modal-footer">
                                                                    <a href="https://www.gofounders.net/user_profile/dellibrary/MTA1Mw==" class="abc"><button type="button" class="btn btn-danger">Yes delete it!</button></a>
   ...
   <!--  end for each loop -->
        ...
        <input type="hidden" name="userid" id="userid" value="29980">
                ...
                <input type="hidden" id="show1" name="" value="Present">

                <input type="hidden" id="show2" name="" value="Present">

                <input type="hidden" id="show3" name="" value="Present">
...
<script src="https://www.gofounders.net/assests/css/gallery/lightgallery-all.min.js"></script>
<script src="https://www.gofounders.net/assests/css/gallery/jquery.mousewheel.min.js"></script>
