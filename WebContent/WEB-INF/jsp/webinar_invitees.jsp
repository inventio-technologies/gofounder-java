   ...
   <head>
      ...
      <script type="text/javascript">
         function openDialog(userId){
        	  window.open ('openDialog?userId='+userId, 'newwindow', 
        			   config='height=470, width=800, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no');
         }
      </script>
      <script type="text/javascript">
          function BacktoInvitees(){
        	  window.location.href="<%=request.getContextPath()%>/myinvitees";
          }
      </script>
      ...
      <script>    
          ...
          function setWebInviteeId(inviteeIdVal){
        	  document.getElementById("id").value = inviteeIdVal;
          }
      </script>
      <style>
         .c-view i {
                     ...
                     <div class="card shadow">
                        <div class="container mt-3">
                           ...
                           <p align="right" class="invitees-m member-p">
                              ...
                              <button class="btn btn-primary frm_top_btn mb-0 " onclick="BacktoInvitees();"> 
                              Back To My Invitees  <img src="https://www.gofounders.net/assests/emoji/img/group.png" style="height:12px;"> 
                              </button>
                              </a>
                              <a href="WebinarInvitee.csv" data-toggle="modal" data-target="#myModal_a" style="padding: 0% 0% 0% 0%;"><button class="btn btn-primary" style=""> Broadcast <i class="fa fa-envelope"></i></button></a>
                              <button data-toggle="modal" data-target="#myModal00" class="btn btn-primary" style="">
                                 Export
                                 CSV File 
                                 <svg aria-hidden="true" data-prefix="far" data-icon="file-excel" class="svg-inline--fa fa-file-excel fa-w-12" role="img" xmlns="http://www.w3.org/20/svg" viewBox="0 0 384 512" width="16px" height="16px">
                           ...
                           <div class="row mb-3">
                              ...
                              <div class="col-sm-8">
                                 <form action="searchWebinarInv" method="post">
                                    <div class="input-group">
                                       <c:if test="${search_val eq ''}">
                                           <input type="text" class="form-control" placeholder="Search with First Name, Last Name, Email Address" name="search_val">
                                       </c:if>
                                       <c:if test="${search_val ne ''}">
                                           <input type="text" class="form-control" placeholder="Search with First Name, Last Name, Email Address" name="search_val" value="${search_val}">
                                       </c:if>
                           ...
                           <div class="tab-content border mb-3">
                              <div id="home" class="container tab-pane active">
                                 ...
                                 <form:form action="" method="post" modelAttribute="goUserWebinar" >
                                    <table class="table align-items-center table-flush" id="">
                                       ...
                                       <tbody>
                                          <c:set value="${goUserWebinar}" var="webinvite" scope="session" />
<%--                                           <%
                                              request.setAttribute("goUserWebinar", '${goUserWebinar}');
                                          %> --%>
                                          <c:forEach items="${webinvite}" var="item" varStatus="status">
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                   <label>${item.fName}</label>
                                                </td>
                                                <td>
                                                   <label>${item.lName}</label>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                   ...
                                                   <div class="actions">
                                                    ...
                                                    <%--   <a href="#" title="Mail" class="mr-2" onclick="openDialog(${item.id})"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                                     ...
                                                     --%>
                                                       ...
                                                       <a href="#" title="Mail" class="mr-2" data-toggle="modal" data-target=".send_mail_modal" onClick="setValueInModalMail('${item.fName}','${item.lName}','${item.emailAddress}')"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                                      
                                                      <a href="" data-toggle="modal" data-target=".delete_modal" title="Delete" data-placement="top" onclick="setWebInviteeId(${item.id})"><i class="fa fa-times" style="font-size:20px"></i></a>
                                    ...
                                    <div class="col-lg-6 p-result text-right">
                                       <span>
                                          <p class="m-b" style="margin-bottom: 0;   
                                             ...
                                             ${fn:length(webinvite)} of ${fn:length(webinvite)}                                          
                                          </p>
                                       </span>
                                    </div>
                                 </div>
               ...
               <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                     <div class="modal-body">
                        ...
                        <div class="">
                           <form:form method="post" action="broadCastEmail" enctype="multipart/form-data">
                           <input type="hidden" id="emails" name="emails" value="${emails}" />
                              <!--Body-->
                              <!--  <label for="email">Send email to</label> -->
                              <input type="hidden" class="form-control" id="email1" name="email1" value="${email1}">
                              <div class="form-group">
                                 <label for="subject">Subject</label>
                                 <input type="text" class="form-control" id="sub" name="sub" value="New Message From ${fullName}" readonly="">
                              </div>
                              <input type="hidden" class="form-control" name="date" value="2019/08/07" required="">
                              <div class="form-group">
                                 <label for="email">Message</label>
                                 <textarea name="msg" class="form-control ck_editor" id="editornew" placeholder="Enter your message" style="visibility: hidden; display: none;"></textarea>
                            ...
                            <div class="modal fade s-modal delete_modal" id="" role="dialog">
                                    <div class="modal-dialog modal-sm modal-dialog-centered">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                          ...
                                          <div class="modal-footer">
                                          <form:form action="deleteWebInvitee" class="w-100 text-right" modelAttribute="webInvitee" method="post">
                                             <input type="hidden" name="id" id="id" value="">	
                                             <a href="#"><button type="submit" class="btn btn-danger">Yes delete
                                             it!</button></a>
                                             <button type="button" class="btn btn-default" data-dismiss="modal">No</button>
                                          </form:form>	
                                          </div>
                         ...
                         <!-- MAIL SEND MODAL START -->   
                             
                             <form:form method="post" action="sendMailWebinerInvitee" enctype="multipart/form-data" >
                                 <div class="modal fade send_mail_modal" id="" role="dialog">
                                    <div class="modal-dialog">
                                       <!-- Modal content-->
                                       <div class="modal-content">
                                          <div class="modal-body">
                                             ...
                                             <div class="">
                                                ...
                                                <div class="form-group">
                                                   <div class="input-group mb-2">
                                                      ...
                                                      <textarea name="mailText" class="form-control ck_editor" id="mailText" placeholder="Enter your message" style="visibility: hidden; display: none;"></textarea>
            ...
            <script>
               ...
               CKEDITOR.replaceClass = 'ck_editor';
            ...
            <script>
               function Export()
               {
            	   /* <c:forEach items="${webinvite}" var="item" varStatus="status">
                         ...
                         alert("${item.lName} : "+'${item.lName}');
                         alert("${item.emailAddress} : "+'${item.emailAddress}');
                         alert("${item.dateS} : "+'${item.dateS}');
                
       			   </c:forEach> */
       			   /* var webinvite = '${webinvite}';
                   window.open("exportCSVWebinarInvitee?webinvite="+webinvite, '_blank').close(); */
       			window.open("exportCSVWebinarInvitee", '_blank').close();
               }
            </script>
