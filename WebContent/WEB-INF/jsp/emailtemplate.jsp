			...
			<nav class="navbar navbar-top navbar-expand-md navbar-dark"
				...
				<div class="container-fluid">
					<div
						...
						<!-- Brand -->
						<a class="h4 mb-0 text-white text-uppercase main-title  d-flex"></a>
...
*/
			...
			<div class="container mt-6">
				...
				<div class="row">
							...
							<div class="container mt-3">
								...
								<ul class="nav nav-tabs " role="tablist">
									<li class="nav-item"><a class="nav-link active"
										id="one-tab" href="#home" data-toggle="tab" href="#one"
										role="tab" aria-controls="One" aria-selected="true">Email
											Templates List</a></li>
									<li class="nav-item"><a class="nav-link" id="two-tab"
										href="#menu1" data-toggle="tab" href="#two" role="tab"
										aria-controls="Two" aria-selected="false">Add Email
											Templates </a></li>
									<li class="nav-item"><a class="nav-link" id="two-three"
										href="invitations.html">Back To My Invitations</a></li>
								</ul>
                    ...
                    <i class="fa fa-eye" style="font-size:24px"></i>
                  </button> --> <a title="View"><span
															class="fa fa-eye"
															style="font-size: 24px; cursor: pointer;"
															data-toggle="modal" data-target=".modal_template"></span></a>
														<a href="#" title="Edit"> <i class="fa fa-edit"
															style="font-size: 24px; margin-left: 8px;"></i>
													</a> <a href="" data-toggle="modal"
														data-target=".myModal_delete" title="Delete"><svg
																aria-hidden="true" data-prefix="fas" data-icon="trash"
																class="svg-inline--fa fa-trash fa-w-14" role="img"
																xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"
																width="25px" height="25px" style="margin-top: -10px;">
												...
												<tr>
													...
													<td>
														<p>
															Awesome, you are in<br> Thanks for registering to
															become a founder!<br> <br> Click the link below
															to verify your Email address<br> Your account has
															been created, you can login with the following
															credentials&nbsp;<br> <br> Email:&nbsp;<a
																href="mailto:paultanmoy.1992@yahoo.com" target="_blank">paultanmoy.1992@yahoo.com</a><br>
															Password: 12345678<br> <br> Please click this
															link to activate your account:<br> <br> See you
															inside<br> Make it a great day!
														</p>
													</td>
                    ...
                    <i class="fa fa-eye" style="font-size:24px"></i>
									...
									<div id="menu1" class="container tab-pane fade" role="tabpanel"
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="form-group">
															<label class="" for="input-first-name">Title</label> <input
																type="text" class="form-control " name="title"
																required=""> <input type="hidden"
																class="form-control " name="duplicate_title"
																value="Personalized Invitation">
														</div>
													</div>
													<div class="col-lg-12">
														<div class="form-group">
															<label class="" for="input-first-name">Template
																Content</label>

															<textarea class="form-control ckeditor-area" name="name"></textarea>


														</div>
													</div>

													<input type="hidden" name="userid" value="7364"> <input
														type="submit" class="btn btn-primary" name="sbmt"
														value="Add" style="margin-left: 20px;"> &nbsp;
													<button type="button" class="btn btn-info btn-lg"
														data-toggle="modal" data-target="#spammodal">
														Spam Trigger Words</button>
												</div>
			...
			<div class="modal fade modal_template" role="dialog">
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="form-group">
								<label for="email">Title</label> <input type="text" name=""
									class="form-control" readonly="" value="test2">
							</div>
							<div class="form-group">
								<label for="pwd">Template Content</label>
								<textarea class="form-control  ckeditor-area" id="editor2"
									readonly="">&lt;p&gt;Awesome, you are in&lt;br /&gt;
     ...
     Make it a great day!&lt;/p&gt;
			...
			<div class="modal fade s-modal myModal_delete" id="" role="dialog">
				<div class="modal-dialog modal-sm modal-dialog-centered">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<a href="#"><button type="button" class="btn btn-danger">Yes
									delete it!</button></a>
							<button type="button" class="btn btn-default"
			...
			<div class="modal fade" id="email_temp_spam_id" role="dialog">
				<div class="modal-dialog modal-lg">
					...
					<div class="modal-content text-center">
						...
						<div align="center" class="modal_heading">Note: Please
							ensure a smooth delivery of this email by replacing the
							highlighted spam-triggered words .</div>
						<hr class="new1">
			...
			<input type="hidden" id="show" name="" value=""> <input
				...
				type="hidden" id="show2" name="" value="Not Updated2"> <input
				type="hidden" id="show3" name="" value="Not Updated3">
			...
			<script>
				function validateBadText() {
					...
					var mail_template_content = CKEDITOR.instances.template_id_user
							.getData();
			...
			<script>
				CKEDITOR.replaceClass = 'ckeditor-area';
			</script>
