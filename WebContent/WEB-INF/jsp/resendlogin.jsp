                        ...
                        <div class="registration-fields forgot-pass reset-login">
                            ...
                            <div class="row justify-content-center">
                                ...
                                <div class="col-11 ">
                                    ...
                                    <h4 class="text-uppercase font-weight-bold text-center mt-4">Resend login Information</h4>
  
                                                      
                                                      <form:form class="form-horizontal mt-5" id="resendloginForm" modelAttribute="login" action="resendloginupdate" method="post">
                                        <fieldset>
                                            <div class="row">

                                                <div class="form-group col-12">
                                                 
                                                    <form:input path="resendemail" name="resendemail" id="resendemail" placeholder="Email Address" class="form-control" required="required" />		    
                                                </div>
                                                                  <input type="hidden" name="re_password" placeholder=" New Password" value="380666516">
            
            

                                                <div class="submit-btn col-12 text-center mt-5">
                                                    <button type="submit" class="btn btn-warning btn-lg">Resend Login Information</button>
                                                </div>
