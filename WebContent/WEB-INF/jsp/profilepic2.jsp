						...
						<div class="card-body">
							...
							<div class="row avatars">
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									...
									<%-- <img src="<c:url value="/images/avtar1.png"/>" class="img-thumbnail" alt=""> --%>
									<img class="img-thumbnail" id="101"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar1.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6  col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail" id="102"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar2.png" alt="">
									</a>
								</div>

								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail" id="103"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar3.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar4.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar5.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar6.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-6 col-sm-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar7.png" alt="">
									</a>
								</div>
							</div>
							<div class="row avatars">
								...
								<div class="col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar8.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar9.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar11.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar12.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar13.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar14.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar15.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar16.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar17.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar18.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar19.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar20.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar21.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar22.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar23.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar24.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar25.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar26.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar27.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar28.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar29.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar30.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar31.png" alt="">
									</a>
								</div>
								...
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar32.png" alt="">
									</a>
								</div>
								<div class=" col-lg-2 col-sm-6 col-6 thumb padding">
									<a class="thumbnail" href="JavaScript:Void(0);"> <img
										class="img-thumbnail"
										src="https://d1iy5wifs53qnq.cloudfront.net/avtar33.png" alt="">
									</a>
								</div>
															...
															<a class="thumbnail" href="JavaScript:Void(0);">
																<div class="library-thumb"
																	...
																	<img class="img-thumbnail"
																		src="https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg"
																		alt="">
																</div>
															</a>
														</div>
...
.then((willDelete) => {
  if (willDelete) {
   ...
   $.ajax({
    url:"<?php echo base_url(); ?>user_profile/pic_change",
    method:"POST",
    data:{file:file,huserid:huserid},
    success:function(data){

     
      window.location.href='<?php echo base_url().'user_profile/profilepic'; ?>';
