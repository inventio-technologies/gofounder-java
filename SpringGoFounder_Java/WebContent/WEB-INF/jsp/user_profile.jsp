...
<body>
    ...
    <div class="main-wrapper">
        ...
        <div class="page-container">
            ...
            .bg-secondary {
                background-color: #fb9b13 !important;
            }
            .card {
                border-bottom: 20px solid #fb9b13;
            }
            ...
            <!--<div class="col-xl-8 order-xl-1">-->
              ...
              <div class="" style="margin-top: 5%;">
                  <div class="card bg-secondary shadow tophead">
                      <div class="card-header tophead">
                          <div class="row align-items-center newbg_grand py-5">
                                <div class="col-lg-4">
                                <div class="profile-thumb-area text-center">
                                           <span class="avatar avatar-sm rounded-circle profilepicbig avatar-bg" style="background-image:url('https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg')">
                                               
                                            </span>
                                   <a href="profilepic.html">
                                            <img src="https://d1iy5wifs53qnq.cloudfront.net/assests/emoji/img/editwhite.png" alt="Edit Picture" class="" style="-webkit-filter: saturate(100%);   filter: saturate(100%);"> </a>
                                </div>
                               </div>
                              <div class="col-lg-4 col-md-12 col-sm-12">
                                  <a class="underline"> <span class="font">You Are Sponsored By: </span>
                                      <span class="box">Tanmoy Paul</span></a>
                                  <br><br>
                                  <a class="underline"> <span class="font">Sponsor Phone:
                                      </span>
                                      <span class="box"> 869685968 </span>
                                  </a>
                              </div>
                              <div class="col-lg-4" style="color: #fff;">
                                  <a class="underline"> <span class="font">Sponsor Country:
                                      </span>
                                        <span class="box"> India </span></a>
            
                                  <br><br>
            
                                  <a class="underline"> <span class="font">Sponsor Email:
                                      </span>
                                      <span class="box"> paultanmoy.1992@gmail.com</span></a>
                              </div>
                          </div>
                      </div>
                      <div class="card-body" style="">
                          <form method="post" action="" style="padding: 20px 20px 60px;" class="newbg_grand">
                              <div class="">
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-username">ID</label>
                                              <input type="text" id="input-username" class="form-control form-control-alternative" readonly="" value="29980">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              ...
                                              <input type="text" id="input-email" name="first_name" class="form-control form-control-alternative" value="Saikat" required="">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-email">Last Name</label>
                                              <input type="text" id="input-email" name="last_name" class="form-control form-control-alternative" value="Bose" required="">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-first-name">Email ID</label>
                                              <input type="text" id="input-first-name" class="form-control form-control-alternative" readonly="" value="saikat@inventiotechnologies.com">
                                          </div>
                                      </div>
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-last-name">Phone</label>
                                              <input type="text" id="input-last-name" class="form-control form-control-alternative onlynumber" name="phone" value="8515928306" required="">
                                  ...
                                  <div class="row">
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-first-name">Sponsor Name</label>
                                              <input type="text" id="input-first-name" class="form-control form-control-alternative" readonly="" name="sponser_name" value="Tanmoy Paul">
                                          </div>
                                      </div>  
                                      <div class="col-lg-6">
                                          <div class="form-group">
                                              <label class="form-control-label" for="input-last-name">Date</label>
                                                                                 <input type="text" id="input-last-name" class="form-control form-control-alternative" name="date" readonly="" value="Apr 3, 2019">
                                          </div>
                                      </div>
                                  </div>
                                  <div class="row">
                                  ...
                                  <div class="row">
                                      <div class="col-12 phcenter">
                                          <span class="firstbtns">
                                              <input  class="btn btn-primary" value="Update">
                                              <a href="index.html" class="btn btn-primary">Cancel</a>
                                              <a href="password_change.html" class=" btn btn-primary">Change Password</a>
                                                <a href="library.html" class=" btn btn-warning btn-fluid">My Library</a>
                                          </span>
                                          <span class="lastbtn">
                                            </span>     
                                                                    </div>
                  ...
                  <input type="hidden" id="firstName" name="" value="Saikat">
                  <input type="hidden" id="lastName" name="" value="Bose">
                  <script>
