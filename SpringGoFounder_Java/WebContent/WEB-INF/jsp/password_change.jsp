                  ...
                  <div class="row">
                    ...
                    <div>
                      ...
                      <div class="card bg-secondary shadow">
                        ...
                        <div class="card-body" style="background: #0e659c url(https://www.gofounders.net/assests/img/pattern2.png);">
            
                          <form method="post" action="https://www.gofounders.net/user_profile/passwordupdate" style="padding:20px 10px 50px; ">               
                              ...
                              <div class="row">
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="password" id="input-username" name="password" class="form-control form-control-alternative" value="" required="" aria-autocomplete="list">
                                    ...
                                    <input type="password" id="input-username" name="cpassword" class="form-control form-control-alternative" value="" required="">
                               ...
                               <a href="https://www.gofounders.net/user_profile"><input type="button" class="btn btn-primary" name="cancel" value="Cancel"></a> 
