    ...
    <div class="main-wrapper">
            ...
            <div class="sidebar">
                    <div class="sidebar-inner">
                        ...
                        <a href="#" class="menu-bar d-md-none navbar-toggler" data-toggle="collapse" data-target="#g-toogler" aria-controls="g-toogler" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <div class="collapse navbar-collapse" id="g-toogler">
                            <ul class="sidebar-menu mb-0" style="">
                                                    <li class="nav-item">
                                    <a class="sidebar-link activenow" href="https://www.gofounders.net/users/dashboard">
            ...
            <!--                                <img id="webniar" src="https://www.gofounders.net/assests/img/icon_notifications.gif"
                                 ...
                                 <li class="nav-item">
                                    <a class="sidebar-link " href="https://www.gofounders.net/user_link">
                                         <span class="icon-holder">
                                 ...
                                 <li class="nav-item">
                                    <a class="sidebar-link " href="https://www.gofounders.net/download">
                                        ...
                                        <span style="color:rgb(255, 205, 23);"> &nbsp;<b>(119)</b></span>
                                    </a>
                                </li>
                        ...
                        <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
                                    <div class="container-fluid">
                                        ...
                                        <li class="nav-item dropdown community-list-item">
                                                ...
                                                <span class="total-notifiocation" id="com_count_total_not">46</span>
                                            ...
                                            <div class="notification-row " id="notify_com_popup_bx">
                                                ...
                                                <div class="px-3 py-3" id="com_noti_headlines">
                                                                                                                        <h6 class="text-sm text-muted m-0">New <strong class="text-primary" id="count_community">23</strong> communities posted by <span>Administrator</span></h6>
                                                                                    <h6 class="text-sm text-muted m-0">You have <strong id="count_comment_reply" class="text-primary">8</strong> New replies for <span>Comments</span></h6>
                                                                                    <h6 class="text-sm text-muted m-0">You have <strong class="text-primary" id="count_comment_likes">15</strong> New likes for <span>Comments</span></h6>
                                            ...
                                            <div class="list-group list-group-flush">
                                                    <ul id="all_ul"> 
                                                                ...
                                                                <a href="javascript:void(0);" class="poscom_1441050 community-new-popup" id="1441050">
                                                                Adminstrator posted community <span><p><span style="font-size:20px;">Let's Celebrate Again!</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1406882 community-new-popup" id="1406882">
                                                                Adminstrator posted community <span><p><span style="color:#008000;"><span style="font-size:24px;">Gooooo Algeria Gooooooo<br>
                If everyone is moving forward together, then success takes care of itself</span></span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1372874 community-new-popup" id="1372874">
                                                                Adminstrator posted community <span><p><span style="font-size:26px;"><strong>You have within: the strength, the patience, and the passion to reach for the stars to change the world.</strong></span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1339012 community-new-popup" id="1339012">
                                                                Adminstrator posted community <span><p><strong>The future belongs to those who believe in the beauty of their dreams</strong></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1305149 community-new-popup" id="1305149">
                                                                Adminstrator posted community <span><p><span style="font-size:20px;"><strong>Every great dream begins with a dreamer</strong></span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1261132 community-new-popup" id="1261132">
                                                                Adminstrator posted community <span><p>Thank You!</p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1205111 community-new-popup" id="1205111">
                                                                Adminstrator posted community <span><p><span style="font-size:24px;">Let's PLAY BIG All The Way</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1141058 community-new-popup" id="1141058">
                                                                Adminstrator posted community <span><p><span style="font-size:36px;">Life is Goooooooooooood</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1109080 community-new-popup" id="1109080">
                                                                Adminstrator posted community <span><p><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30">&nbsp;<img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><span style="color:#0000CD;"><strong><span style="font-size:22px;">WE ARE IN IT TO WIN IT&nbsp;</span></strong></span><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"><img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/travel/fireworks.png" title="Fireworks" width="30"></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1077176 community-new-popup" id="1077176">
                                                                Adminstrator posted community <span><p><span style="font-size:28px;">FREEDOM&nbsp;<img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/flags/united-states.png" title="United states" width="30">&nbsp;FREEDOM&nbsp;<img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/flags/united-states.png" title="United states" width="30">&nbsp;FREEDOM&nbsp;<img height="30" src="https://d1iy5wifs53qnq.cloudfront.net/assests/ckeditor/plugins/hkemoji/sticker/flags/united-states.png" title="United states" width="30"></span></p>
                </span>                                              <br>Posted on : <label> 
                                                                12:19pm on Thursday, July 4th, 2019</label>
                                                                </a>
                                                        </li>      
                                                                                            <li onclick="fn_update_comment_like('102125', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/WIN_20170401_17_34_25_Pro.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_102125 comment-like-new-popup" id="102125">
                                                                Your comment is liked by <span>Robert  Rioux</span>                                              <br>Posted on : <label> 
                                                                11:46pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_reply('11750', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/DSC03269.JPG - 1.jpg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11750 comment-reply-new-popup" id="11750">
                                                                A reply for a comment is posted by <span>John E. Stratmann</span>                                              <br>Posted on : <label> 
                                                                09:27pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_comment_like('101950', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/DSC03269.JPG - 1.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101950 comment-like-new-popup" id="101950">
                                                                Your comment is liked by <span>John E. Stratmann</span>                                              <br>Posted on : <label> 
                                                                09:25pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101845', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/Deb NMB 2.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101845 comment-like-new-popup" id="101845">
                                                                Your comment is liked by <span>Debra Baxter</span>                                              <br>Posted on : <label> 
                                                                08:08pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_reply('11713', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/ME1.jpg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11713 comment-reply-new-popup" id="11713">
                                                                A reply for a comment is posted by <span>Willie Lewis  Combs</span>                                              <br>Posted on : <label> 
                                                                07:24pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_reply('11707', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/734637869B8E957F7-FBE7-41BD-BC90-ABA0AF7C959D.jpeg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11707 comment-reply-new-popup" id="11707">
                                                                A reply for a comment is posted by <span>Colin Stein</span>                                              <br>Posted on : <label> 
                                                                06:43pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_comment_like('101713', '29980');"> <span class="notif-thumb">AT</span>                                              <a href="javascript:void(0);" class="comment_like_101713 comment-like-new-popup" id="101713">
                                                                Your comment is liked by <span>Alayne Tribolet</span>                                              <br>Posted on : <label> 
                                                                06:29pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101671', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/FB_IMG_1541620126671.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101671 comment-like-new-popup" id="101671">
                                                                Your comment is liked by <span>Angela Nycz</span>                                              <br>Posted on : <label> 
                                                                06:20pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101539', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/Bonnie_Swift_Johnson.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101539 comment-like-new-popup" id="101539">
                                                                Your comment is liked by <span>LaVonne  Johnson</span>                                              <br>Posted on : <label> 
                                                                05:39pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101533', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1883199439matt.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101533 comment-like-new-popup" id="101533">
                                                                Your comment is liked by <span>Matt Mihalicz</span>                                              <br>Posted on : <label> 
                                                                05:35pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_reply('11692', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/3601168188F321F69-DF92-4C38-B9B7-FD62269D7E36.jpeg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11692 comment-reply-new-popup" id="11692">
                                                                A reply for a comment is posted by <span>Robert James Guenther</span>                                              <br>Posted on : <label> 
                                                                05:20pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_comment_like('101501', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1667531100NandC.PNG)"></span>                                              <a href="javascript:void(0);" class="comment_like_101501 comment-like-new-popup" id="101501">
                                                                Your comment is liked by <span>Clara Nolt</span>                                              <br>Posted on : <label> 
                                                                04:54pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101492', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/523773445Timm Guitar2.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101492 comment-like-new-popup" id="101492">
                                                                Your comment is liked by <span>Timm Johnson</span>                                              <br>Posted on : <label> 
                                                                04:39pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_reply('11684', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/93887246820190621_174858.jpg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11684 comment-reply-new-popup" id="11684">
                                                                A reply for a comment is posted by <span>James Williams</span>                                              <br>Posted on : <label> 
                                                                03:46pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_reply('11681', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/214661496901.jpg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11681 comment-reply-new-popup" id="11681">
                                                                A reply for a comment is posted by <span>Pierre Nortier</span>                                              <br>Posted on : <label> 
                                                                03:36pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_reply('11672', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/Victoria.jpg)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11672 comment-reply-new-popup" id="11672">
                                                                A reply for a comment is posted by <span>Victoria  Leal</span>                                              <br>Posted on : <label> 
                                                                02:33pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_comment_like('101354', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1935042225dreamcatcher owl.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101354 comment-like-new-popup" id="101354">
                                                                Your comment is liked by <span>Valerie Griffith</span>                                              <br>Posted on : <label> 
                                                                12:37pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_reply('11666', '29980');">
                                                                <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1244931821stuart.png)"></span>                                              <a href="javascript:void(0);" class="reply_detail_11666 comment-reply-new-popup" id="11666">
                                                                A reply for a comment is posted by <span>Stuart  Clark</span>                                              <br>Posted on : <label> 
                                                                12:33pm on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>   
                                                                                                    <li onclick="fn_update_comment_like('101315', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/Michael Carden.png)"></span>                                              <a href="javascript:void(0);" class="comment_like_101315 comment-like-new-popup" id="101315">
                                                                Your comment is liked by <span>Michael Carden</span>                                              <br>Posted on : <label> 
                                                                11:57am on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101304', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/19773527581545543_1398169693764903_1088984184_n(4).jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101304 comment-like-new-popup" id="101304">
                                                                Your comment is liked by <span>Laszlo Szabo</span>                                              <br>Posted on : <label> 
                                                                11:46am on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101300', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/avtar13.png)"></span>                                              <a href="javascript:void(0);" class="comment_like_101300 comment-like-new-popup" id="101300">
                                                                Your comment is liked by <span>Mr. Ash</span>                                              <br>Posted on : <label> 
                                                                11:36am on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101286', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1085021743IMG_20190616_204638.jpg)"></span>                                              <a href="javascript:void(0);" class="comment_like_101286 comment-like-new-popup" id="101286">
                                                                Your comment is liked by <span>Pongrac Gal</span>                                              <br>Posted on : <label> 
                                                                11:20am on Friday, June 28th, 2019</label>
                                                                </a>
                                                        </li>
                                                                                                    <li onclick="fn_update_comment_like('101283', '29980');"> <span class="notif-thumb" style="background:url(https://d1iy5wifs53qnq.cloudfront.net/1690416466IMG_0006.JPG)"></span>                                              <a href="javascript:void(0);" class="comment_like_101283 comment-like-new-popup" id="101283">
                                                                Your comment is liked by <span>Mpumelelo Khumalo</span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1045971 community-new-popup" id="1045971">
                                                                Adminstrator posted community <span><p><span style="font-size:24px;">The <strong>BEST DAYS </strong>in our Life are ahead</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_1014998 community-new-popup" id="1014998">
                                                                Adminstrator posted community <span><p><strong><span style="font-size:20px;">It's Real - It's Happening&nbsp;</span></strong></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_984344 community-new-popup" id="984344">
                                                                Adminstrator posted community <span><p>Go Go Go&nbsp;Argentina!!! YOU DID IT&nbsp;</p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_924397 community-new-popup" id="924397">
                                                                Adminstrator posted community <span><p><span style="font-size:24px;">30,000 + Stars&nbsp;</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_894987 community-new-popup" id="894987">
                                                                Adminstrator posted community <span><p><strong><span style="font-size:20px;">It's Real - It's Happening&nbsp;</span></strong></p>
                </span>                                              <br>Posted on : <label> 
                                                                12:49pm on Tuesday, June 25th, 2019</label>
                                                                </a>
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_865648 community-new-popup" id="865648">
                                                                Adminstrator posted community <span><p>Go Go Go&nbsp;Argentina!!! YOU DID IT&nbsp;</p>
                </span>                                              <br>Posted on : <label> 
                                                                10:03pm on Friday, June 21st, 2019</label>
                                                                </a>
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_807099 community-new-popup" id="807099">
                                                                Adminstrator posted community <span><p><span style="font-size:24px;">30,000 + Stars&nbsp;</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                03:31am on Tuesday, June 25th, 2019</label>
                                                                </a>
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_749099 community-new-popup" id="749099">
                                                                Adminstrator posted community <span><p><span font-size:24px="" style="\">We Believe In You .. We Appreciate You</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_721003 community-new-popup" id="721003">
                                                                Adminstrator posted community <span><p><span style="color:#0066ff;"><span style="font-size:26px;">Onward And Upward</span></span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_693100 community-new-popup" id="693100">
                                                                Adminstrator posted community <span><p><span style="font-size:20px;">To Our&nbsp;Fellow Americans...Founders and Families&nbsp;</span></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_665687 community-new-popup" id="665687">
                                                                Adminstrator posted community <span><p><span style="font-size:26px;">Raw Uncut Interview&nbsp;</span><br>
                <strong><span style="font-size:26px;">Eric Green<br>
                Scott Nelson<br>
                Ash Mufareh</span></strong></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_256297 community-new-popup" id="256297">
                                                                Adminstrator posted community <span><p><strong><span style="color:#3366ff;"><span style="font-size:20px;">We Believe in YOU</span></span></strong></p>
                </span>                                              <br>Posted on : <label> 
                                                                ...
                                                                <span class="notif-thumb"></span>  
                                                                <a href="javascript:void(0);" class="poscom_45881 community-new-popup" id="45881">
                                                                Adminstrator posted community <span><p><strong><span style="font-size:20px"><span style="color:#3366ff">Go Founders Goooooooooooooo</span></span></strong></p>
                </span>                                              <br>Posted on : <label> 
                                          ...
                                          <ul class="navbar-nav align-items-center ml-md-auto n-menu" style="margin-left: 20px !important;">
                                            <li class="nav-item dropdown">
                                                                          <span class="total-notifiocation totalnoti"> <div class="plus_sign">99+</div>  </span>
                                              ...
                                              <a class="position-relative notification-icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                               ...
                                               <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary inviteesnoti">1</strong> notifications from <span>Team :</span></h6>
                                                </div>
                                                ...
                                                <div class="list-group list-group-flush">
                                                 ...
                                                 <a href="javascript:void(0);" class="addDetailsuser" id="saikat@inventiotechnologies.com">
                                                    <li>
                                                          ...
                                                          Your new team member is <span>sachin deoo</span>                                     
                                                                             ...
                                                                             <input type="hidden" name="" id="teamlist" value="saikat@inventiotechnologies.com">   
                                              </ul>    
                                               ...
                                               <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary inviteesnoti">1</strong> notifications from <span>Webinar Invitees :</span></h6>
                                                </div>
                                               ...
                                               <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary">72</strong> notifications from <span>Webinar</span></h6>
                                                </div>
                                              ...
                                              <input type="hidden" name="" id="idslist" value="26,27,28,29,30,31,45,46,47,48,50,51,52,53,54,55,56,57,60,61,62,64,65,66,67,68,70,71,74,75,76,77,78,80,81,82,83,84,85,86,87,88,90,91,92,93,94,95,96,97,99,100,101,102,103,104,105,106,107,108,109,110,111,112,113,114,115,116,117,119,120,122"> 
                                               ...
                                               <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary">1</strong> notifications from <span>Announcement</span></h6>
                                                </div>
                    ...
                    <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary">119</strong> notifications from <span>Download</span></h6>
                                                </div>
                                     ...
                                     <div class="notification-row">
                                                ...
                                                <div class="px-3 py-3">
                                                  <h6 class="text-sm text-muted m-0">You have <strong class="text-primary">1</strong> notifications from <span>Marketing</span></h6>
                                                </div>
                                                  ...
                                                  <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                      <div class="media align-items-center">
                                                          ...
                                                          <!--</span>-->
                                                           ...
                                                           <span class="avatar avatar-sm rounded-circle avatar-bg" style="background-image:url('https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg')">
                      ...
                      <div class="card bg-secondary shadow">  
                        ...
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" id="101" src="https://d1iy5wifs53qnq.cloudfront.net/avtar1.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6  col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" id="102" src="https://d1iy5wifs53qnq.cloudfront.net/avtar2.png" alt="">
                            </a>
                        </div>
            
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" id="103" src="https://d1iy5wifs53qnq.cloudfront.net/avtar3.png" alt="">
                            </a>
                        </div>
                      <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar4.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar5.png" alt="">
                            </a>
                        </div>
                        ...
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar6.png" alt="">
                            </a>
                        </div>
                                <div class=" col-lg-2 col-6 col-sm-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar7.png" alt="">
                            </a>
                        </div>
                            </div>
                            <div class="row avatars">
                        ...
                        <div class="col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar8.png" alt="">
                            </a>
                        </div>
                        ...
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar9.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar11.png" alt="">
                            </a>
                        </div>
                            <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar12.png" alt="">
                            </a>
                        </div>
                            ...
                            <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar13.png" alt="">
                            </a>
                        </div>
                        ...
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar14.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar15.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar16.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar17.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar18.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar19.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar20.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar21.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar22.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar23.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar24.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar25.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar26.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar27.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar28.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar29.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar30.png" alt="">
                            </a>
                        </div>
                        
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar31.png" alt="">
                            </a>
                        </div>
                        
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar32.png" alt="">
                            </a>
                        </div>
                        <div class=" col-lg-2 col-sm-6 col-6 thumb padding">
                            <a class="thumbnail" href="JavaScript:Void(0);">
                                <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/avtar33.png" alt="">
                            </a>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-12 formblock">
                                      ...
                                      <div class="row">
                                         ...
                                         <div class=" cust pr-lg-4">
                                          ...
                                          <div class="row">
                                            ...
                                            <div class="box-input">
                                              ...
                                              <label for="file-7"><span>No file choosen</span> <strong><svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" viewBox="0 0 20 17">
                                                <path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"></path></svg> Upload a file…</strong></label>
                                            </div>
                                          ...
                                          <div class="row">
                                            ...
                                            <input type="hidden" name="huserid" id="huserid" value=" 29980">
                                          </div>
            
                                          <input type="submit" class="btn btn-primary mr-2" name="save" value="Save">
                                          <a href="user_profile.html"><input type="button" class="btn btn-primary" name="cancel" value="Cancel"></a>
                                        ...
                                        <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#myModal">Open Library</button>
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                          <div class="modal-content">
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-6">
                                                                                                                                 ...
                                                                                                                                 <a class="thumbnail" href="JavaScript:Void(0);">
                                                                      <div class="library-thumb" style="background-image:url(https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg)">
                                                                           <img class="img-thumbnail" src="https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg" alt="">
                                                                          </div>
                                                                          </a>
