			...
			<div class="modal-body">
				...
				<div class="">
					...
					<div class="form-group focused">
						<div class="input-group mb-2">
							...
							<input type="text" class="form-control" id="name"
								value="${goUserWebinar.fName} ${goUserWebinar.lName}" name="name" readonly="">
						</div>
					</div>
					<div class="form-group focused">
						<div class="input-group mb-2">
							...
							<input type="text" class="form-control" id="sub"
								placeholder="Subject"
								value="New Message For ${goUserWebinar.fName} ${goUserWebinar.lName}" name="sub"
								readonly="">
						</div>
					</div>
					<input type="hidden" class="form-control" id="email" name="email"
						value="${goUserWebinar.emailAddress}">
					...
					<div class="text-center">
						    ...
						    <input type="hidden" id="userMail" name="userMail" value="${goUserWebinar.emailAddress}" />
