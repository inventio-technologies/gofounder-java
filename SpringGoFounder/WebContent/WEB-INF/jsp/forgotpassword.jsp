        ...
        <div class="register-section">
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-7">
                        <div class="registration-fields forgot-pass">
                            ...
                            <div class="row justify-content-center">
                                   ...
                                   <div class="col-lg-12 ">
                                    ...
                                    <h4 class="text-uppercase font-weight-bold text-center mt-4">Reset Password</h4>
                                                      
                  					<span style="color: #CD2706; text-align: center;">${status}</span>
                                    <form:form cssClass="form-horizontal mt-5" action="forgotpassword" method="post">
                                                <input type="hidden" name="password" placeholder=" New Password" value="558880440">
                                        <fieldset>
                                            <div class="row">
