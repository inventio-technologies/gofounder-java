                     ...
                     <div class="card shadow">
                        <div class="container mt-3">
                           ...
                           <p align="right" class="invitees-m member-p">
                              <a href="webinarinvitees"  style="padding: 0% 0% 0% 0%;" class="first d-inline-block" ><button class="btn btn-primary frm_top_btn mb-0"> Webinar Invitees <img src="https://d1iy5wifs53qnq.cloudfront.net/assests/emoji/img/group.png" style="height:12px;"> </button></a>
                              ...
                              <button data-toggle="modal" data-target="#myModal00" class="btn btn-primary" style="">
                                 Export CSV File 
                              ...
                              <div class="col-sm-8">
                                 <form action="#"
                                    ...
                                    <div class="input-group">
                                       <input type="text" class="form-control" placeholder="Search with First Name, Last Name, Email Address"
                                          name="search_val" required>
                                       <button class="btn btn-default" type="submit" id="btn"><img
                           ...
                           <div class="tab-content border mb-3">
                              <div id="home" class="container tab-pane active">
                                 ...
                                 <table class="table align-items-center table-flush" id="">
                                    ...
                                    <tbody>
                                       <tr>
                                          ...
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal1"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0011" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   ...
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText1();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="Rabindra Mridha" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Rabindra Mridha" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         ...
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <textarea  name="msg" class="form-control" id="editor_1" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             bappa.programmer@gmail.com
                                          </td>
                                          <td>
                                             Aug 2, 2019
                                          </td>
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal2"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0012" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText2();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="Bappa Ghosh" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Bappa Ghosh" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         ...
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <textarea  name="msg" class="form-control" id="editor_2" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                                         <div class="row mb-4 mt-4">
                                                            <div class="col-lg-6">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             nadarnikesh@gmail.com
                                          </td>
                                          <td>
                                             Jul 26, 2019
                                          </td>
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal3"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0013" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText3();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="Nikesh Nadar" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Nikesh Nadar" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         <input type="hidden" class="form-control" id="email" name="email" value="nadarnikesh@gmail.com" >
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                                  <div class="input-group-text"><i class="fa fa-comment text-info"></i></div>
                                                               </div>
                                                               <textarea  name="msg" class="form-control" id="editor_3" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                                         <div class="row mb-4 mt-4">
                                                            <div class="col-lg-6">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             tanmoy@inventiotechnologies.com
                                          </td>
                                          <td>
                                             Jul 2, 2019
                                          </td>
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal4"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0014" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText4();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="T P" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For T P" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         <input type="hidden" class="form-control" id="email" name="email" value="tanmoy@inventiotechnologies.com" >
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                                  <div class="input-group-text"><i class="fa fa-comment text-info"></i></div>
                                                               </div>
                                                               <textarea  name="msg" class="form-control" id="editor_4" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                                         <div class="row mb-4 mt-4">
                                                            <div class="col-lg-6">
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             subarnamaitra8@gmail.com
                                          </td>
                                          <td>
                                             Jun 29, 2019
                                          </td>
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal5"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0015" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText5();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="Subarna Maitra" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Subarna Maitra" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         <input type="hidden" class="form-control" id="email" name="email" value="subarnamaitra8@gmail.com" >
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                                  <div class="input-group-text"><i class="fa fa-comment text-info"></i></div>
                                                               </div>
                                                               <textarea  name="msg" class="form-control" id="editor_5" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                                         <div class="row mb-4 mt-4">
                                                            <div class="col-lg-6">
                                       ...
                                       <script>
                                          function validateBadText5(){
                                              ...
                                              var mail_template_content =  CKEDITOR.instances.editor_5.getData();
                                             // mail_template_content = mail_template_content.replace(/[\s]+/g, " ").trim();
                                             var replace_with_str = "";
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             saikatbose1234@gmail.com
                                          </td>
                                          <td>
                                             Mar 20, 2019
                                          </td>
                                          <td> <a href="#" class="mr-2" data-placement="top" title="Mail"  data-toggle="modal" data-target="#myModal6"> <i class="fa fa-envelope" style="font-size:20px"></i></a>
                                             <a href="" data-toggle="modal" data-target="#myModal0016" title="Delete" 
                                                data-placement="top" title="Delete"><i class="fa fa-times" style="font-size:20px"></i></a>
                                          </td>
                                       </tr>
                                          ...
                                          <div class="modal-dialog">
                                             ...
                                             <div class="modal-content">
                                                <div class="modal-body">
                                                   <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                   <div class="">
                                                      <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText6();">
                                                         <!--Body-->
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                               ...
                                                               <input type="text" class="form-control" id="name" value="Saikat Bose" name="name" readonly>
                                                            </div>
                                                         </div>
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               ...
                                                               <input type="text" class="form-control" id="sub" placeholder="Subject" value="New Message For Saikat Bose" name="sub" readonly >
                                                            </div>
                                                         </div>
                                                         <input type="hidden" class="form-control" id="email" name="email" value="saikatbose1234@gmail.com" >
                                                         <div class="form-group">
                                                            <div class="input-group mb-2">
                                                               <div class="input-group-prepend">
                                                                  <div class="input-group-text"><i class="fa fa-comment text-info"></i></div>
                                                               </div>
                                                               <textarea  name="msg" class="form-control" id="editor_6" placeholder="Enter your message" required></textarea>
                                                            </div>
                                                         </div>
                                                         <div class="row mb-4 mt-4">
                                                            <div class="col-lg-6">
                                       ...
                                       <script>
                                          function validateBadText6(){
                                              ...
                                              var mail_template_content =  CKEDITOR.instances.editor_6.getData();
                                             // mail_template_content = mail_template_content.replace(/[\s]+/g, " ").trim();
                                             var replace_with_str = "";
                                 ...
                                 <div class="row align-items-center" style="padding: 15px 0;    background: #eaeaea;">
                                    ...
                                    <div class="col-lg-6 p-result text-right">
                                       <span>
                                          <p class="m-b" style="margin-bottom: 0;
                                             font-weight: 600;
                                             text-transform: capitalize;"> showing  from  1  to 6 of 6</p>
                                       </span>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="modal-body">
                        ...
                        <div class="">
                           <form method="post" action="#" enctype="multipart/form-data" onsubmit="return validateBadText();">
                              <!--Body-->
                              <input type="hidden" class="form-control" id="email1" name="email1" value="r.mridha@gmail.com,bappa.programmer@gmail.com,nadarnikesh@gmail.com,tanmoy@inventiotechnologies.com,subarnamaitra8@gmail.com,saikatbose1234@gmail.com" >
                              <div class="form-group">
                              ...
                              <div class="form-group">                                  
                                 ...
                                 <textarea  name="msg" class="form-control" id="editornew" placeholder="Enter your message" required=""></textarea>                                   
                              </div>
                              <div class="row mb-4 mt-4">
                                 <div class="col-lg-6">
                  ...
                  <div class="modal-content">
                     ...
                     <div class="modal-body spam-count">
                        <p>Avoid Terms and Words that can Trigger spam filtration which can block
                           ...
                           avoid for healthier email delivery -
                        </p>
