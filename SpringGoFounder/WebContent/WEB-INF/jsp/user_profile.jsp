	...
	color: #000;
				...
				<div class="" style="margin-top: 5%;">
							...
							<div class="row align-items-center newbg_grand py-5">
								<div class="col-lg-4">
									<div class="profile-thumb-area text-center">
										<span
											class="avatar avatar-sm rounded-circle profilepicbig avatar-bg"
											style="background-image: url('https://d1iy5wifs53qnq.cloudfront.net/1118697793saikat.jpg')">

										</span> <a href="profilepic.html"> <img
											src="https://d1iy5wifs53qnq.cloudfront.net/assests/emoji/img/editwhite.png"
											alt="Edit Picture" class=""
											style="-webkit-filter: saturate(100%); filter: saturate(100%);">
										</a>
									</div>
								</div>
								<div class="col-lg-4 col-md-12 col-sm-12">
									<a class="underline"> <span class="font">You Are
											Sponsored By: </span> <span class="box">Tanmoy Paul</span></a> <br>
									<br> <a class="underline"> <span class="font">Sponsor
											Phone: </span> <span class="box"> 869685968 </span>
									</a>
								</div>
								<div class="col-lg-4" style="color: #fff;">
									<a class="underline"> <span class="font">Sponsor
											Country: </span> <span class="box"> India </span></a> <br>
									<br> <a class="underline"> <span class="font">Sponsor
											Email: </span> <span class="box"> paultanmoy.1992@gmail.com</span></a>
								</div>
							</div>
						</div>
						<div class="card-body" style="">
							<%-- <form:form method="post" action="saveProfile" style="padding: 20px 20px 60px;" modelAttribute="user" cssClass="newbg_grand"> --%>
							<form:form action="saveProfile" cssStyle="padding: 20px 20px 60px;" method="post" modelAttribute="user" cssClass="newbg_grand">
								<div class="">
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label" for="input-username">ID</label>
												<form:input path="userId" cssClass="form-control form-control-alternative" />
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label" for="input-email">First
													Name</label> <form:input path="firstname" cssClass="form-control form-control-alternative"/>
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label" for="input-email">Last
													Name</label> <form:input path="lastname"
													cssClass="form-control form-control-alternative"/>
											</div>
										</div>
									</div>
										...
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label" for="input-first-name">Email
													ID</label> <form:input path="email"
													cssClass="form-control form-control-alternative" />
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												...
												<form:input path="phone" cssClass="form-control form-control-alternative onlynumber"/>
												<!-- <div class="error_msg"
													style="display: none; color: #ff0000; padding-top: 15px;">Only
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label class="form-control-label" for="input-first-name">Sponsor
													Name</label> <form:input path="sponsorName" cssClass="form-control form-control-alternative" />
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-12 phcenter">
											<span class="firstbtns"> <input type="submit"
												class="btn btn-primary" value="Update"> <a
												href="index.html" class="btn btn-primary">Cancel</a> <a
												href="password_change.html" class=" btn btn-primary">Change
													Password</a> <a href="library.html"
												class=" btn btn-warning btn-fluid">My Library</a>
											</span> <span class="lastbtn"> </span>
										</div>
									</div>
									<div class="row justify-content-center">
										<div class="col-lg-6">
											<span class="library-btn"> </span>
										</div>
									</div>
								</div>
							</form:form>
					...
					<input type="hidden" id="show" name="" value=""> <input
						...
						type="hidden" id="show3" name="" value=""> <input
						type="hidden" id="firstName" name="" value="Saikat"> <input
						type="hidden" id="lastName" name="" value="Bose">
					<script>
